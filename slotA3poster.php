...
<body>
        ...
        <div class="content-wrapper">
          ...
          <style>
            ...
            .container {
              ...
              color: white;
              overflow: auto;
              /*allow the container to scroll if the number of slot exceeds available height*/
            }
          ...
          <div class="container">
            ...
            <div class="item">
              ...
              <i class="mdi mdi-clipboard-text"></i> Slot 3
              <a class="nav-link" href="A3posterform.php"></a>
              <P class="card-description">Available</P>
            ...
            <div class="item">
              ...
              <i class="mdi mdi-clipboard-text"></i> Slot 4
              <a class="nav-link" href="A3posterform.php"></a>
              <P class="card-description">Available</P>
            </div>
            ...
            <div class="item">
              ...
              <i class="mdi mdi-clipboard-text"></i> Slot 5
              <a class="nav-link" href="A3posterform.php"></a>
              <P class="card-description">Available</P>
            ...
            <div class="item">
              ...
              <i class="mdi mdi-clipboard-text"></i> Slot 6
              <a class="nav-link" href="A3posterform.php"></a>
              <P class="card-description">Available</P>
            ...
            <div class="item">
              ...
              <i class="mdi mdi-clipboard-text"></i> Slot 7
              <a class="nav-link" href="A3posterform.php"></a>
              <P class="card-description">Available</P>
            </div>
            ...
            <div class="item">
              ...
              <i class="mdi mdi-clipboard-text"></i> Slot 8
              <a class="nav-link" href="A3posterform.php"></a>
              <P class="card-description">Available</P>
  ...
  <script>
    let slotCounter = 9; // Start counting from Slot 9 since Slot 1,2,3 already exists
