          ...
          <div class="row">
            ...
            <div class="row justify-content-center">
              <div class="col-md-6 grid-margin stretch-card">
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Visual Merchandise Booking Form</h4>
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="form-group">
                        <label for="exampleInputProduct">Campaign Name/Product</label>
                        <input type="text" class="form-control" id="exampleInputProduct" placeholder="Product">
                      </div>
